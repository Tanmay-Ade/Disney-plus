  ...
  return (
    ...
    <div className="flex overflow-x-auto w-full px-16 py-4 scrollbar-none scroll-smooth" ref={elementRef}>
        {movieList.map((item,i)=>(
            <img key={i} src={IMAGE_BASE_URL+item.backdrop_path} className="min-w-full md:h-[310px] object-center object-cover mr-5 rounded-md hover:border-[4px] border-gray-400 transition-all duration-100 ease-in" />
        ))}
    </div>
    </div>
  )
